...
class BookHandler
{
    ...
    {
        $books = Db::retrieveAll("SELECT books.`name`, books.`url`, authors.name, authors.surname, authors.nationality FROM `books` JOIN authors ON books.author_id=authors.author_id");
        return $books;
    }
